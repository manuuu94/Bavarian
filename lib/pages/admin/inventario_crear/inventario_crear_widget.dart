...
import 'inventario_crear_model.dart';
export 'inventario_crear_model.dart';

class InventarioCrearWidget extends StatefulWidget {
  const InventarioCrearWidget({Key? key}) : super(key: key);

  @override
  _InventarioCrearWidgetState createState() => _InventarioCrearWidgetState();
}

class _InventarioCrearWidgetState extends State<InventarioCrearWidget> {
  late InventarioCrearModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InventarioCrearModel());
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              5.0, 5.0, 5.0, 5.0),
                          child: TextFormField(
                            controller: _model.nombreProductoController,
                            ...
                            decoration: InputDecoration(
                              ...
                              fillColor: FlutterFlowTheme.of(context)
                                  .secondaryBackground,
                              suffixIcon: _model
                                      .nombreProductoController!.text.isNotEmpty
                                  ? InkWell(
                                      onTap: () async {
                                        _model.nombreProductoController
                                            ?.clear();
                            ...
                            validator: _model.nombreProductoControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              5.0, 5.0, 5.0, 5.0),
                          child: TextFormField(
                            controller: _model.descripcionProductoController,
                            onChanged: (_) => EasyDebounce.debounce(
                            ...
                            decoration: InputDecoration(
                              ...
                              fillColor: FlutterFlowTheme.of(context)
                                  .secondaryBackground,
                              suffixIcon: _model.descripcionProductoController!
                                      .text.isNotEmpty
                                  ? InkWell(
                                      onTap: () async {
                                        _model.descripcionProductoController
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              5.0, 5.0, 5.0, 5.0),
                          child: TextFormField(
                            controller: _model.cantidadProductoController1,
                            onChanged: (_) => EasyDebounce.debounce(
                            ...
                            decoration: InputDecoration(
                              ...
                              fillColor: FlutterFlowTheme.of(context)
                                  .secondaryBackground,
                              suffixIcon: _model.cantidadProductoController1!
                                      .text.isNotEmpty
                                  ? InkWell(
                                      onTap: () async {
                                        _model.cantidadProductoController1
                            ...
                            validator: _model
                                .cantidadProductoController1Validator
                                .asValidator(context),
                          ),
                        ),
                      ),
