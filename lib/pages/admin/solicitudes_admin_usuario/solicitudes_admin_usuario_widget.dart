...
class SolicitudesAdminUsuarioWidget extends StatefulWidget {
  const SolicitudesAdminUsuarioWidget({Key? key}) : super(key: key);
...
class _SolicitudesAdminUsuarioWidgetState
  ...
  void initState() {
    ...
    _model.telefonoController ??= TextEditingController(text: 'whatsapp');
    _model.correoController ??= TextEditingController(text: 'correo');
  }
