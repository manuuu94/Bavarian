...
import 'inventario_editar_model.dart';
...
class _InventarioEditarWidgetState extends State<InventarioEditarWidget> {
  late InventarioEditarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InventarioEditarModel());
