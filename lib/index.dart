...
export '/pages/admin/solicitudes_admin_lista/solicitudes_admin_lista_widget.dart'
    show SolicitudesAdminListaWidget;
...
export '/pages/admin/solicitudes_admin_menu/solicitudes_admin_menu_widget.dart'
