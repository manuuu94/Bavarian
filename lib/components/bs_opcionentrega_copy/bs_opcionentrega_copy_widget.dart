          ...
          children: [
            Expanded(
              child: Padding(
                ...
                child: StreamBuilder<List<DeliveryOptionsRecord>>(
                  stream: queryDeliveryOptionsRecord(),
                  builder: (context, snapshot) {
                    ...
                    List<DeliveryOptionsRecord>
                        gridViewDeliveryOptionsRecordList = snapshot.data!;
